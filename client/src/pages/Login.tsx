...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-background via-background/95 to-muted/20 flex items-center justify-center p-3 sm:p-4">
      <div className="w-full max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
          
          {/* Left Side - Compact Branding & Features */}
          <div className="hidden lg:flex flex-col justify-center space-y-8 px-6">
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <Logo width={48} height={48} />
                <div>
                  <h1 className="text-3xl font-semibold tracking-tight">Lumina Outreach</h1>
